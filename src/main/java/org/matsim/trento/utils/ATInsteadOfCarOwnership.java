...
import org.matsim.trento.utils.ATPassengerTracker;

/**
* @author ikaddoura
*/

public class ATInsteadOfCarOwnership implements PersonEntersVehicleEventHandler {
	private static final Logger log = Logger.getLogger(ATInsteadOfCarOwnership.class);
	...
	private final ATPassengerTracker savTracker;	
	private final Scenario scenario;

	private final double dailyReward;
	private final String carMode;
	
	public ATInsteadOfCarOwnership(Scenario scenario, ATPassengerTracker savTracker, double dailyReward, String carMode) {
