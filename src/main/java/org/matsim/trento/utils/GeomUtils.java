...
public class GeomUtils {
	...
	public static Map<String,Geometry> readShapeFileAndExtractGeometry(String filename){
		return readShapeFileAndExtractGeometry(filename, "sez");
	}
	...
	public static Map<String,Geometry> readShapeFileAndExtractGeometry(String filename, String key){
		...
		for (SimpleFeature ft : ShapeFileReader.getAllFeatures(filename)) {
				...
				try {
					Geometry geo = wktReader.read((ft.getAttribute("the_geom")).toString()); //the_geom
					String sez = ft.getAttribute(key).toString();
					geometry.put(sez, geo);
