...
public class RunRobotaxiExample {
	...
	public static void main(String[] args) {
		String configFile = "scenarios/AT introduction/robotaxi_config.xml";
		RunRobotaxiExample.run(configFile, false);
	}

	public static void run(String configFile, boolean otfvis) {
		Config config = ConfigUtils.loadConfig(configFile, new DvrpConfigGroup(), new TaxiFareConfigGroup(), new RoadPricingConfigGroup(), new SwissRailRaptorConfigGroup(),
