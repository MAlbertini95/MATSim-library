 ...
 *
 */
public class CreateAVRobotaxiVehicles {
	...
	public static void main(String[] args) {
		...
		int numberofVehicles = 7000;
		double operationStartTime = 0.; //t0
		double operationEndTime = 24*3600.;	//t1
		int seats = 2;
		String networkfile = "scenarios/AT introduction/Trento_network.xml";
		String taxisFile = "scenarios/AT introduction/ATfleet_"+numberofVehicles+"_"+seats+".xml";
		...
		for (int i = 0; i< numberofVehicles;i++){
			...
			vehicles.add(ImmutableDvrpVehicleSpecification.newBuilder().id(Id.create("ATaxi" + i, DvrpVehicle.class))
