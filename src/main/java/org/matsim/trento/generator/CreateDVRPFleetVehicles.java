 ...
 */
public class CreateDVRPFleetVehicles {

	/**
	 * Adjust these variables and paths to your need.
	 */

	private static final int numberOfVehicles = 5000;
	...
	private static final Path networkFile = Paths.get("scenarios/Trento_Calibrated/Trento_network.xml");
	private static final Path outputFile = Paths.get("scenarios/Trento_Calibrated/fleetVehicles0.xml");

	public static void main(String[] args) {

		new CreateDVRPFleetVehicles().run();
	}
