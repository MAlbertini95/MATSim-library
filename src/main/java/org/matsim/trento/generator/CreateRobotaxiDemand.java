...
public class CreateRobotaxiDemand {
    ...
    public static void main(String[] args) {
        ...
        new CreateRobotaxiDemand().run(inputPopulation, outputPopulation, 1.0);
    ...
    public void run(String inputPopulationFile, String outputPopulationFile, Double robotaxiShare) {
        for (int i = 5; i < 10; i++) {
            ...
            replaceMode(TransportMode.car, TransportMode.ride, "ATaxi", robotaxiShare, scenario, new Random(42 - i));
