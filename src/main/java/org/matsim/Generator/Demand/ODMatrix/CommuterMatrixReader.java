...
public class CommuterMatrixReader {

	private static final Logger log = Logger.getLogger(CommuterMatrixReader.class);
	...
	public CommuterMatrixReader(String shapeFile) {
	...
	private void readMatrix(final String filename) {
		...
		new TabularFileParser().parse(tabFileParserConfig,
			...
			public void startRow(String[] row) {
				...
				Integer quelle = null;
				Integer ziel = 0;
				// car market share for commuter work/education trips 
				double carMarketShare = 0.67;
				// scale factor, since CommuterMatrix only considers a share of total trips
