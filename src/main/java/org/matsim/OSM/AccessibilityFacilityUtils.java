...
class AccessibilityFacilityUtils {
	...
	// Kinderkrippe/-garten
	// Grundschule
	// weiterfuÌˆhrende Schule (inkl. Berufs- und Hochschule)
	// andere Bildungseinrichtung
	// Einkauf tÃ¤glicher Bedarf
	// sonstiger Einkauf
	// Ã–ffentliche Einrichtung (z. B. BehÃ¶rde, Ã„rztehaus, Post, Bank,...)
	// Kultur, Theater, Kino
	// GaststÃ¤tte/Kneipe
	// Privater Besuch (fremde	Wohnung)
	// Erholung/Sport im Freien (auch Wandern, Hund ausfuÌˆhren o. Ã¤.)
	// SportstÃ¤tte (allgemein)
	// groÃŸe Sonderveranstaltung (z.B. Rockkonzert, Sportereignis)
	// andere FreizeitaktivitÃ¤t
	// eigene Wohnung
	// sonstiges
	// keine Angabe
