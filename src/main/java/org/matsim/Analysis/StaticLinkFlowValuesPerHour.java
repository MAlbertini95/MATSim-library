 ...
 * @author tthunig
 */
public class StaticLinkFlowValuesPerHour implements LinkEnterEventHandler, VehicleEntersTrafficEventHandler{

	private static final Logger LOG = Logger.getLogger(StaticLinkFlowValuesPerHour.class);
