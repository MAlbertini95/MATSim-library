...
import org.matsim.Analysis.ActDurationHandler;
import org.matsim.Analysis.BasicPersonTripAnalysisHandler;
import org.matsim.Analysis.PersonTripAnalysis;
import org.matsim.Network.Network2Shape;
import org.matsim.Visualize.GISAnalyzer;
import org.matsim.Visualize.MATSimVideoUtils;
import org.matsim.Visualize.VisualizationScriptAdjustment;
...
public class MatsimAnalysis {
	...
	private List<AnalysisAgentFilter> agentFilters;
	...
	public void run() {
		...
		if (scenario1 != null) {
			...
			if (agentFilters != null) {
				for (AnalysisAgentFilter filter : agentFilters) {
...
//			vttsHandler0.computeFinalVTTS();
		...
		if (scenario1 != null & scenario0 != null) {
			...
			for (AnalysisAgentFilter agentFilter : this.agentFilters) {
	...
	private void printResults(Scenario scenario,
		...
		for (AnalysisAgentFilter agentFilter : agentFilters) {
...
/*		vttsHandler.printVTTS(vttsOutputDirectory + scenario.getConfig().controler().getRunId() + "." + "VTTS_allTrips.csv");
	...
	public void setAgentFilters(List<AnalysisAgentFilter> filters) {
