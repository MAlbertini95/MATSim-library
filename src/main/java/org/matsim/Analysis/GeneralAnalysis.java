 ...
 */
@Singleton
public final class GeneralAnalysis implements PersonDepartureEventHandler, PersonArrivalEventHandler, LinkEnterEventHandler, LinkLeaveEventHandler, VehicleEntersTrafficEventHandler, VehicleLeavesTrafficEventHandler, PersonStuckEventHandler {
...
//	private Map<Id<Link>, Map<Double, Double>> avgSpeedPerLinkPerHour;
	...
	public GeneralAnalysis(Network network) {
		this.network = network;
	}
	
	@Inject
	public GeneralAnalysis(Network network, EventsManager em) {
		this(network);
		em.addHandler(this);
	}
