...
/**
* @author teoal on the basis of ikaddoura
*/

public class MapWalkAndBicycleDemandToNetwork {

	public static void main(String[] args) throws IOException {
		String outputFile = "Path to output/Walk-Bicycle-demand.txt";
		int scaleFactor = 10;
		...
		config.network().setInputFile("Path to input network/network.xml.gz");
		config.plans().setInputFile("Path to input file/output_plans.xml.gz");
