...
//	private static String runDirectory = "../../runs-svn/cottbus/mt-its19/2019-02-5-17-22-3_1000it_Sylvia_noFixedCycle_maxExt1.5_cap07_fixSensor/";
	...
	public static void main(String[] args) {
		...
		SubnetworkAnalyzer subNetAnalyzer = new SubnetworkAnalyzer(subnetworkFeature, fullNetwork);
	...
	private static void writeItAnalysis(SubnetworkAnalyzer subNetAnalyzer, int iteration) {
