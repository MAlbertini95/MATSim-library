 ...
 * @author tthunig
 */
public class SubnetworkAnalysisWriter implements IterationEndsListener{

	private static final Logger log = Logger.getLogger(SubnetworkAnalysisWriter.class);
	
	private Scenario scenario;
	private SubnetworkAnalyzer subNetAnalyzer;
	private String outputDirBase;
	private PrintStream overallItWritingStream;
	private int lastIteration;
	
	@Inject
	public SubnetworkAnalysisWriter(Scenario scenario, SubnetworkAnalyzer subNetAnalyzer) {
