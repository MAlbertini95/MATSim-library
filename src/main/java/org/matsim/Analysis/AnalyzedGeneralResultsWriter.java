 ...
 *
 */
public final class AnalyzedGeneralResultsWriter {

	private static final Logger log = Logger.getLogger(AnalyzedGeneralResultsWriter.class);
	
	private Scenario scenario;
	private GeneralAnalysis handler;
	...
	@Inject
	public AnalyzedGeneralResultsWriter(Scenario scenario, GeneralAnalysis handler) {
