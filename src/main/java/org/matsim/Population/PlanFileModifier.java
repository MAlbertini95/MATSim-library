...
/**
 * @author teoal customized jbischoff
 * 
...
public class PlanFileModifier {
	...
	public static void main(String[] args) {
		...
		// Local use		
		String inputPlansFile = "Path to input plans file/plans.xml.gz";
		String outputPlansFile = "Path to output modified plans/plans_modified.xml.gz";
