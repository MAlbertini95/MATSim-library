...
public class ZoneBasedDrtCustomerWaitHandler implements PersonDepartureEventHandler, PersonEntersVehicleEventHandler {
	...
	private Map<String,int[]> zoneDepartures = new TreeMap<>();
		...
		public ZoneBasedDrtCustomerWaitHandler(Network network,Map<String,Geometry> zones) {
	    ...
	    public void handleEvent(PersonDepartureEvent event){
	        if (!event.getLegMode().equals("ATaxi"))  //alternativamente, equals(TransportMode.taxi)
	            return;
	    ...
	    public void writeCustomerStats(String fileDir){
	    	try {
	            ...
	            bw.write("total number of customer's AT trips: \t" + this.numberOfTrips);
	            bw.newLine();
