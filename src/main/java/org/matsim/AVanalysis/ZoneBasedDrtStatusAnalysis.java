...
public class ZoneBasedDrtStatusAnalysis implements LinkEnterEventHandler, ActivityEndEventHandler {
	...
	public ZoneBasedDrtStatusAnalysis(Network network, Map<String, Geometry> zones) {
	...
	public void handleEvent(ActivityEndEvent event) {
		...
		} else if (event.getActType().startsWith("TaxiPickup")) { 
		...
		} else if (event.getActType().startsWith("TaxiDropoff")) { 
	...
	public void evaluateAndWriteOutput(String outputDir) {
		evaluateZones();
		writeLinkStats(outputDir + "drtLinkstats.csv");
		writeZoneStats(outputDir + "drtZoneStats.csv");
		writeHourlyStats(outputDir + "drtHourlyStats.csv");
	}
