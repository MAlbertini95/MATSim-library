 ...
 * 
 */
public class FootballTraveltimeHandler implements PersonDepartureEventHandler, PersonArrivalEventHandler, PersonStuckEventHandler {
	...
	public FootballTraveltimeHandler(){
		this.reset(0);
	}
...
//		}
	...
	private void handleArrival(Id<Person> personId, double time) {
		...
		if (personId.toString().endsWith(FanFootballStrings.SPN2FB)) {
		...
		if (personId.toString().endsWith(FanFootballStrings.CB2FB)) {
